%Tau-leap model for our poliovirus model with quarantine of asymptomatic
%infections
function [Classes] = Tauleap_polio_model_quarantine_Ia(para,ICs,maxtime,tau)
    ...
    while ((t<maxtime) && ( (Ia>0)||(Is>0)||(Vopv>0) ))
        ...
        r_10 = para.q*Ia; %Quarantine of an asymptomatic individual.
        ...
        S = S - X_1 - X_2 - X_6;
        Is = Is + X_1 - X_8;
        Ia = Ia + X_2 + X_3 + X_4 + X_5 + X_7 - X_9 - X_10;
        Vipv = Vipv - X_3 + X_6;
        Vopv = Vopv - X_4 - X_7;
        Q = Q + X_10 - X_11;
